...
class MelBanks {
 public:
  ...
  static inline BaseFloat MelScale(BaseFloat freq) {
    //return freq;
    BaseFloat x;
    x=1127.0f * logf (1.0f + freq / 700.0f);

    float w[23] = {3.262, 8.877, 5.41, 1.867, 0.758, 0.268, 0.085, 0.002, 0.004, 0.001, 0.0, 0.0, 0.003, 0.017, 0.03, 0.176, 0.355, 0.487, 0.521, 0.402, 0.318, 0.141, 0.005};
    int k;
    k=int(x / 124);
    BaseFloat s = 0;
    for (int i = 0; i < k; i++) {
