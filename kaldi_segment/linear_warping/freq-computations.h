...
class FreqBanks {
 public:
  ...
  static inline BaseFloat FreqScale(BaseFloat freq) {
    float w[40] = {15.963, 3.4, 0.888, 0.173, 0.001, 0.009, 0.001, 0.001, 0.0, 0.002, 0.03, 0.054, 0.04, 0.078, 0.23, 0.519, 0.855, 0.929, 0.901, 1.051, 1.384, 1.535, 1.275, 1.003, 0.952, 0.972, 1.062, 1.05, 0.873, 0.703, 0.542, 0.438, 0.342, 0.19, 0.047, 0.0, 0.034, 0.036, 0.074, 2.34};
    int k;
    k=int(freq / 200);
    BaseFloat s = 0;
    for (int i = 0; i < k; i++) {
