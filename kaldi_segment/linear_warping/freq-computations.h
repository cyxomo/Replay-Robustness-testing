...
class FreqBanks {
 public:
  ...
  static inline BaseFloat FreqScale(BaseFloat freq) {
    float w[23] = {5.474, 0.997, 0.003, 0.002, 0.001, 0.006, 0.069, 0.106, 0.539, 1.317, 1.542, 2.006, 2.333, 1.797, 1.609, 1.662, 1.37, 0.926, 0.641, 0.271, 0.004, 0.062, 0.257};
    int k;
    k=int(freq / 348);
    BaseFloat s = 0;
    for (int i = 0; i < k; i++) {
